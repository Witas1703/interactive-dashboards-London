...
dashboardPage(title = 'COVID in London', skin = "black", 
              ...
              dashboardSidebar(
                sidebarMenu(
                  ...
                  menuItem("Symptoms checker", tabName = "4", icon = icon("poll-h"))
                  ...
                  tabItem(tabName = "start",
                          mainPanel(
                            fluidPage( theme = shinytheme("yeti"),
                                       ...
                                       hr(),
                                       h4("About"),
                                       p("The project itself is a part of our data visualization course at Poznan University of Technology. You can jump directly into universitiy's webpage by clicking the logo in the upper-right corner."),
                                       br(),
